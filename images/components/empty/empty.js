...
Component({
  ...
  data: {
    ...
    errorLayoutData: {
      ...
      src: "/components/empty/res/image/icon_empty_error.png",
      prompt: "加载出错了...",
      btnPrompt: "重新加载"
    },
    emptyLayoutData: {
      emptyType: EmptyConstant.empty,
      src: "/components/empty/res/image/icon_empty_empty.png",
      prompt: "数据为空...",
      btnPrompt: "重新加载"
    },
    loadingLayoutData: {
      emptyType: EmptyConstant.loading,
      src: "/components/empty/res/image/icon_empty_loading.png",
      prompt: "加载中...",
      btnPrompt: null
    }
  },
